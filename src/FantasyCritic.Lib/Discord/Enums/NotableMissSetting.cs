...
public class NotableMissSetting : TypeSafeEnum<NotableMissSetting>
{
    ...
    /// </summary>
    public static readonly NotableMissSetting None = new NotableMissSetting("None", "None");
    /// <summary>
    ...
    /// </summary>
    public static readonly NotableMissSetting InitialScore = new NotableMissSetting("InitialScore", "Initial Score");
    /// <summary>
    ...
    /// </summary>
    public static readonly NotableMissSetting ScoreUpdates = new NotableMissSetting("ScoreUpdates", "Score Updates");

    /// <summary>
    /// The score threshold for a game to be considered a notable miss.
    /// </summary>
    public static readonly decimal Threshold = 83m;

    public string ReadableName { get; }
    public override string ToString() => Value;

    private NotableMissSetting(string value, string readableName)
        : base(value)
    {
