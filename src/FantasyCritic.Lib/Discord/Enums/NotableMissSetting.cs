...
public class NotableMissSetting : TypeSafeEnum<NotableMissSetting>
{
    ...
    /// </summary>
    public static readonly NotableMissSetting InitialScore = new NotableMissSetting("InitialScore", "Initial Score", $"Only Notable Missed Games that intially Scored **{Threshold}** or Higher will be sent to the channel");
    /// <summary>
