...
public class AdvancedGameNewsSettings
{
    ...
    public IReadOnlyList<MasterGameTag> SkippedTags { get; set; } = new List<MasterGameTag>();
    ...
    public AdvancedGameNewsSettings(MultiYearLeagueChannel? leagueChannel, GameNewsOnlyChannelRecord? gameChannel )
    {
